...
export function Cart({ visible, toggle }) {
  ...
  return (
    <>
      <div className={`cart fixed top-0 bottom-0 left-0 w-[300px] lg:w-[400px] bg-gray-300 dark:bg-[#161414] p-5 duration-300 z-[50] ${visible ? 'translate-x-0' : 'translate-x-[-400px]'}`}>
      ...
      {visible &&
        <div onClick={toggle} className="backdrop fixed top-0 left-0 right-0 w-screen bottom-0 bg-black/30 z-10"></div>
      }
    </>
  )
}